...
import androidx.media3.effect.GlEffectFactory
...
import androidx.media3.transformer.TransformerException
    ...
    suspend fun rotateAndFlipVideo(
        ...
        try {
            ...
            val editedMediaItem = EditedMediaItem.Builder(mediaItem)
                .setEffects(listOf(transformation))
                .build()
